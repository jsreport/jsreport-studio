...
module.exports = (reporter, definition) => {
  ...
  const titleTemplate = _.template(definition.options.title, templateSettings)
  // eslint-disable-next-line no-template-curly-in-string
  const defaultTitleTemplate = _.template(definition.optionsSchema.extensions.studio.properties.title.default, templateSettings)
