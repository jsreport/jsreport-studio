...
module.exports = (reporter, definition) => {
  ...
  reporter.documentStore.on('after-init', () => {
    // initializing the interval after document store initialization because the flush logs reads from store
    // and it needs the store to be ready, otherwise there can be race conditions
