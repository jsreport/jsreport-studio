  ...
  reporter.on('express-configure', () => {
    ...
    if (reporter.options.mode !== 'jsreport-development') {
      ...
      if (fs.existsSync(path.join(distPath, 'extensions.client.js'))) {
        ...
        webpackWrap = fs.readFileSync(path.join(distPath, '1.client.js'), 'utf8')
      }
      ...
      client1jsContent = webpackExtensions
    } else {
    ...
    app.get('/studio/assets/1.client.js', (req, res) => res.send(client1jsContent))
